...
class _SideMenuItemState extends State<SideMenuItem> {
  ...
  Widget _generateIcon(Icon? mainIcon, Widget? iconWidget, SideMenuDisplayMode value) {
    final iconColor = widget.priority == currentPage
        ? Global.style.selectedIconColor ?? Colors.black
        : SMColors.menuUnselectedTextColor;
    ...
    if(value != SideMenuDisplayMode.compact) {
      return icon;
    }
    ...
    if (widget.badgeContent != null) {
      return Stack(
        ...
        children: [
          icon,
          Positioned(
            top: -3, // Adjust this value based on your design
            right: -3, // Adjust this value based on your design
            child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _generateIcon(widget.icon, widget.iconWidget, value),
                        SizedBox(
                          width: Global.style.itemInnerSpacing,
                        ),
                            ...
                            child: FittedBox(
                              ...
                              child: Text(
                                ...
                                style: widget.priority == currentPage.ceil()
                                    ? const TextStyle(
                                    fontSize: 17, color: SMColors.menuUnselectedTextColor)
                                    .merge(
